                            ...
                            <div class="flex flex-wrap -m-2">
                                ...
                                <div class="w-full p-2">
                                    <div class="relative">
                                        ...
                                        <input type="text" id="url" name="url" class="w-full px-3 py-1 text-base leading-8 text-gray-700 transition-colors duration-200 ease-in-out bg-gray-100 bg-opacity-50 border border-gray-300 rounded outline-none focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200" value={{$contact->url}}>
                                    </div>
                                    </div>
                                    {{-- <?php dd($contact) ?> --}}
                                <div class="w-full p-2">
                                <div class="relative">
                                    <label for="gender" class="text-sm leading-7 text-gray-600">性別</label><br>
                                ...
                                <div class="w-full p-2">
                                <div class="relative">
                                    <label for="contact" class="text-sm leading-7 text-gray-600">お問い合わせ内容</label>
