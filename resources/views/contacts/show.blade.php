                ...
                <section class="relative text-gray-600 body-font">
                    <div class="container px-5 mx-auto">
                        ...
                        <div class="flex flex-wrap -m-2">
                            ...
                            <div class="w-full p-2">
                            <div class="relative">
                                <label for="url" class="text-sm leading-7 text-gray-600">性別</label><br>
                            ...
                            <form method="post" class="mt-40" action="{{route('contacts.destroy', ['id' => $contact->id])}}" id="delete_{{$contact->id}}">
                                @csrf
                                <div class="w-full p-2">
                                <a href="#" data-id="{{ $contact->id }}" onclick="deletePost(this)" class="flex px-8 py-2 mx-auto text-lg text-white bg-pink-500 border-0 rounded focus:outline-none hover:bg-pink-600">削除する</a>
                            </div>
                            </form>
                        </div>
                        </div>
